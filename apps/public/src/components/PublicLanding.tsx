        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-slate-900">Scotch Doubles</span>
            </div>
            <nav className="hidden md:flex items-center gap-6">
              <a href="#" className="text-slate-600 hover:text-blue-600 transition-colors">Tournaments</a>
              <a href="#" className="text-slate-600 hover:text-blue-600 transition-colors">Venues</a>
              <a href="#" className="text-slate-600 hover:text-blue-600 transition-colors">Rankings</a>
